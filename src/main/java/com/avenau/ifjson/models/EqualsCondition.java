...
public class EqualsCondition implements Condition {
    ...
    public Boolean evaluate(HashMap<String, String> variableReplacement) throws Exception {
        if (variableReplacement.containsKey(variable)) {
            ...
            throw new Exception("[EqualsCondition] Variable: " + variable + " does not have value assigned");
        }
    ...
    @Override
    public void print() {
        System.out.println("Condition:{ " + "Type: Equals, " + "variable: " + this.variable + ", Value: " + this.value + ", variable: " + this.value + "}");
